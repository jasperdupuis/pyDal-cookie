...
This is the same as 3100 except also includes model results at Pat Bay!

i.e. incorporates results from 2010, 2013, and 2030 script files.
...
def plot_result_by_type(p_ax,
    ...
    for c in c_select:
        ...
        if 'MSE' in c:
            p_ax.scatter(f,p_df[c].values**0.5,marker=p_marker,label=lab)
        else:
...
if __name__ == '__main__':
    ...
    #                 + r'_' \
    #                 + hydro \
    #                 + r'_dependent_L1_L2_bias_high_capacity.csv'
    # fname_pl_mods   =  coordinate \
    #                 + r'_' \
    #                 + hydro \
    #                 + r'Y_dependent_bias_propagation_models.csv'
    fname           =  coordinate \
                    + r'_dependent_L1_L2_bias_high_capacity.csv'
    fname_pl_mods   =  coordinate \
                    + r'_dependent_bias_propagation_models_'\
                    + hydro \
                    + r'.csv'
    ...
    if ABSOLUTE:
        ...
        plot_result_by_type(axs[2],p_df = df_pl,p_hydro = hydro,p_type='Bias',p_marker='^')
        axs[0].set_ylim([2,7])
        axs[1].set_ylim([2,7])
