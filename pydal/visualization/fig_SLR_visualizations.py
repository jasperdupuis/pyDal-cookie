...
from pydal.models import SLR_with_transforms
...
if COMPARE_P_AND_M:
    ...
    fdir    = _dirs.DIR_THESIS_IMGS #this is where results go
    ...
    for STD in _vars.STANDARDS:
        ...
        fig, axs = plt.subplots(2,figsize=_thesis.WIDE_FIG_SIZE) # axs[0] is top one
        # fig.suptitle('P-value and slope for SLR(y)\n' + STD + ', ' + 'South hydrophone',fontsize=_thesis.FONTSIZE)
